...
public interface IUserService
{
    ...
    /// information, or null if the update fails.
    /// </returns>
    ...
    /// objects. The array will be empty if no users are found.
    /// </returns>
    ...
    /// the user with the specified email address, or <see langword="null"/> if no user is found.
    /// </returns>
